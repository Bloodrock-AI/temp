...
alphabet: dict[str, FunctionCall] = {
    ...
    "C": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=0.90, excluded_values=None, type="float"),
            "y":   FunctionArgument(name="y",   value=-0.10, excluded_values=None, type="float"),
            "z":   FunctionArgument(name="z",   value=0.14, excluded_values=None, type="float"),
    ...
    "C''": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=None, excluded_values=[0.90, 0.95], type="float"),
            "y":   FunctionArgument(name="y",   value=None, excluded_values=[-0.10, 0.20], type="float"),
            "z":   FunctionArgument(name="z",   value=None, excluded_values=[0.14, 0.10], type="float"),
    ...
    "G": FunctionCall(
        name="pick",
        arguments={
            "object_name": FunctionArgument(name="object_name", value="panel_X", excluded_values=None, type="str")
        },
    ),
    "G'": FunctionCall(
        name="pick",
        arguments={
            "object_name": FunctionArgument(name="object_name", value=None, excluded_values=["panel_X"], type="str")
        },
    ),
