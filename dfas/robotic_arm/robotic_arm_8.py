...
alphabet: dict[str, FunctionCall] = {
    ...
    "C''''": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=None, excluded_values=[0.60, 0.95, 0.30, 0.50], type="float"),
            "y":   FunctionArgument(name="y",   value=None, excluded_values=[0.10, 0.20, 0.35, 0.00], type="float"),
            "z":   FunctionArgument(name="z",   value=None, excluded_values=[0.11, 0.10, 0.12, 0.40], type="float"),
