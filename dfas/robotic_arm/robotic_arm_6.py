...
alphabet: dict[str, FunctionCall] = {
    ...
    "C": FunctionCall(
        ...
        arguments={
            ...
            "speed": FunctionArgument(name="speed", value=0.2,  excluded_values=None, type="float"),
        },
    ),
    ...
    "C'": FunctionCall(
        ...
        arguments={
            ...
            "yaw": FunctionArgument(name="yaw", value=1.57, excluded_values=None, type="float"),
        },
    ),
    ...
    "C'''": FunctionCall(
        name="move_to",
        arguments={
            "x":     FunctionArgument(name="x",     value=None, excluded_values=[0.60, 0.80, 0.50], type="float"),
            "y":     FunctionArgument(name="y",     value=None, excluded_values=[0.10, 0.35, 0.00], type="float"),
            "z":     FunctionArgument(name="z",     value=None, excluded_values=[0.11, 0.10, 0.40], type="float"),
            "yaw":   FunctionArgument(name="yaw",   value=None, excluded_values=[0.0, 1.57],       type="float"),
            "speed": FunctionArgument(name="speed", value=None, excluded_values=None,              type="float"),
        },
    ),
    ...
    "G''": FunctionCall(
        name="pick",
        arguments={"object_name": FunctionArgument(name="object_name", value=None, excluded_values=["gear_A", "box_small"], type="str")},
    ),
    ...
    "M": FunctionCall(
        ...
        arguments={"station_name": FunctionArgument(name="station_name", value="packaging_area", excluded_values=None, type="str")},
    ),
    "M'": FunctionCall(
        name="get_station_pose",
        arguments={"station_name": FunctionArgument(name="station_name", value=None, excluded_values=["packaging_area"], type="str")},
    ),
}

READS_ALL = ["I", "J", "K", "L", "L'", "M", "M'"]
READS_G1  = ["J", "K", "L", "L'" "M", "M'"]      # I advances to G2
READS_G2  = ["I", "K", "L", "L'", "M", "M'"]      # J advances to G3
READS_G3  = ["I", "J", "K", "L'", "M", "M'"]      # L advances to G4
READS_G7 = ["I", "J", "K", "L", "L'", "M'"]       # M advances to G8
G0.transitions = [
...
G2.transitions = [
    Transition(symbols=["J"], _from=G2, _to=G3),
    Transition(symbols=READS_G2, _from=G2, _to=G2),
]

G3.transitions = [
    Transition(symbols=["L"], _from=G3, _to=G4),
    Transition(symbols=READS_G3, _from=G3, _to=G3),
]
...
G5.transitions = [
    Transition(symbols=["E"], _from=G5, _to=G6),
...
G7.transitions = [
    Transition(symbols=["M"], _from=G7, _to=G8),
    Transition(symbols=READS_G7, _from=G7, _to=G7),
]

G8.transitions = [
    Transition(symbols=["C'"], _from=G8, _to=G9),
    Transition(symbols=READS_ALL, _from=G8, _to=G8),
]

G9.transitions = [
    Transition(symbols=["H"], _from=G9, _to=G10),
    Transition(symbols=READS_ALL, _from=G9, _to=G9),
]

G10.transitions = [
    Transition(symbols=["C''", "D"], _from=G10, _to=G11),
    Transition(symbols=READS_ALL, _from=G10, _to=G10),
]

G11.transitions = [
    Transition(symbols=["B"], _from=G11, _to=G12),
    Transition(symbols=READS_ALL, _from=G11, _to=G11),
]

G12.transitions = [
    Transition(symbols=READS_ALL, _from=G12, _to=G12),
]
