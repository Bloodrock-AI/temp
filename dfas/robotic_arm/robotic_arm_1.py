...
alphabet: dict[str, FunctionCall] = {
    ...
    "C''": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=None, excluded_values=[0.30, 0.95], type="float"),
            "y":   FunctionArgument(name="y",   value=None, excluded_values=[0.35, 0.20], type="float"),
            "z":   FunctionArgument(name="z",   value=None, excluded_values=[0.12, 0.10], type="float"),
    ...
    "G": FunctionCall(
        name="pick",
        arguments={
            "object_name": FunctionArgument(name="object_name", value="box_small", excluded_values=None, type="str")
        },
    ),
    "G'": FunctionCall(
        name="pick",
        arguments={
            "object_name": FunctionArgument(name="object_name", value=None, excluded_values=["box_small"], type="str")
        },
    ),
