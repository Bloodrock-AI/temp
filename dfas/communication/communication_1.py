...
alphabet: dict[str, FunctionCall] = {
    "A": FunctionCall(
        name="send_message",
        arguments={
            "sender": FunctionArgument(name="sender", value="Alice", excluded_values=None, type="str"),
            "recipient": FunctionArgument(name="recipient", value="Bob", excluded_values=None, type="str"),
            "content": FunctionArgument(name="content", value="Urgent meeting at 3 PM", excluded_values=None, type="str"),
    ...
    "A'": FunctionCall(
        name="send_message",
        arguments={
            "sender": FunctionArgument(name="sender", value=None, excluded_values=["Alice"], type="str"),
            "recipient": FunctionArgument(name="recipient", value=None, excluded_values=["Bob"], type="str"),
            "content": FunctionArgument(name="content", value=None, excluded_values=["Urgent meeting at 3 PM"], type="str"),
