...
G0.transitions = [
    ...
    Transition(symbols=["D", "F", "F'", "F''"], _from=G0, _to=G0),
]

G1.transitions = [
    Transition(symbols=["A'"], _from=G1, _to=G2),
    Transition(symbols=["D", "F", "F'", "F''"], _from=G1, _to=G1),
]
...
G3.transitions = [
    ...
    Transition(symbols=["D", "F", "F''"], _from=G3, _to=G3),
]

G4.transitions = [
    Transition(symbols=["D", "F", "F'", "F''"], _from=G4, _to=G4),
]
