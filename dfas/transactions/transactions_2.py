...
alphabet: dict[str, FunctionCall] = {
    ...
    "B": FunctionCall(
        ...
        arguments={
            "account_id": FunctionArgument(name="account_id", value="A123", excluded_values=None, type="str"),
            "amount": FunctionArgument(name="amount", value=200, excluded_values=None, type="float"),
        },
    ),
    "B'": FunctionCall(
        name="deposit",
        arguments={
            "account_id": FunctionArgument(name="account_id", value=None, excluded_values=["A123"], type="str"),
            "amount": FunctionArgument(name="amount", value=None, excluded_values=[200], type="float"),
        },
    ),
    "C": FunctionCall(
        name="withdraw",
        arguments={
            "account_id": FunctionArgument(name="account_id", value="A123", excluded_values=None, type="str"),
            "amount": FunctionArgument(name="amount", value=100, excluded_values=None, type="float"),
        },
    ),
    "C'": FunctionCall(
        name="withdraw",
        arguments={
            "account_id": FunctionArgument(name="account_id", value=None, excluded_values=["A123"], type="str"),
            "amount": FunctionArgument(name="amount", value=None, excluded_values=[100], type="float"),
        },
    ),
    "D": FunctionCall(
        name="check_balance",
    ...
    "E": FunctionCall(
        name="transfer",
        arguments={
            "sender_id": FunctionArgument(name="sender_id", value=None, excluded_values=None, type="str"),
            "receiver_id": FunctionArgument(name="receiver_id", value=None, excluded_values=None, type="str"),
...
G0.transitions = [
    ...
    Transition(symbols=["D", "F", "F'"], _from=G0, _to=G0),
]
G1.transitions = [
    Transition(symbols=["B"], _from=G1, _to=G2),
    Transition(symbols=["D", "F", "F'"], _from=G1, _to=G1),
]
G2.transitions = [
    Transition(symbols=["C"], _from=G2, _to=G3),
    Transition(symbols=["D", "F", "F'"], _from=G2, _to=G2),
]
G3.transitions = [
...
G4.transitions = [
    Transition(symbols=["D", "F", "F'"], _from=G4, _to=G4),
]
