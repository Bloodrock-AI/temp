...
alphabet: dict[str, FunctionCall] = {
    ...
    "E": FunctionCall(
        name="get_event_time",
        arguments={
            "event_name": FunctionArgument(name="event_name", value="Stand-up Meeting", excluded_values=None, type="str"),
        },
    ),
    "E'": FunctionCall(
        name="get_event_time",
        arguments={
            "event_name": FunctionArgument(name="event_name", value=None, excluded_values=["Stand-up Meeting"], type="str"),
        },
    ),
    "F": FunctionCall(
    ...
    "G": FunctionCall(
        ...
        arguments={
            "event_name": FunctionArgument(name="event_name", value="Stand-up Meeting", excluded_values=None, type="str"),
            "interval_minutes": FunctionArgument(name="interval_minutes", value=30, excluded_values=None, type="int"),
    ...
    "G'": FunctionCall(
        ...
        arguments={
            "event_name": FunctionArgument(name="event_name", value=None, excluded_values=["Stand-up Meeting"], type="str"),
            "interval_minutes": FunctionArgument(name="interval_minutes", value=None, excluded_values=[30], type="int"),
