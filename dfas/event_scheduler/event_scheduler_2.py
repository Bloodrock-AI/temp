...
alphabet: dict[str, FunctionCall] = {
    "A": FunctionCall(
        ...
        arguments={
            ...
            "event_time": FunctionArgument(name="event_time", value="2025-02-10T09:00:00",  excluded_values=None, type="str"),
        },
    ),
    "A'": FunctionCall(
        name="schedule_event",
        arguments={
            ...
            "event_time": FunctionArgument(name="event_time", value=None,  excluded_values=["2025-02-10T09:00:00"], type="str"),
        },
    ),
    "B": FunctionCall(
        name="cancel_event",
