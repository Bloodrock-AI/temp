...
alphabet: dict[str, FunctionCall] = {
    "A": FunctionCall(
        name="schedule_event",
        arguments={
            "event_name": FunctionArgument(name="event_name", value="Project Review", excluded_values=None, type="str"),
            "event_time": FunctionArgument(name="event_time", value="2025-02-11T15:00:00",  excluded_values=None, type="str"),
        },
    ),
    "A'": FunctionCall(
        name="schedule_event",
        arguments={
            "event_name": FunctionArgument(name="event_name", value=None, excluded_values=["Project Review"], type="str"),
            "event_time": FunctionArgument(name="event_time", value=None,  excluded_values=["2025-02-11T15:00:00"], type="str"),
        },
    ),
    "B": FunctionCall(
        name="cancel_event",
    ...
    "D": FunctionCall(
        ...
        arguments={
            "event_name": FunctionArgument(name="event_name", value=None, excluded_values=None, type="str"),
            "new_time": FunctionArgument(name="new_time", value=None,  excluded_values=None, type="str"),
        },
    ),
    "E": FunctionCall(
        name="get_event_time",
...
G1.transitions = [
    ...
    Transition(symbols=["E", "F", "F'"], _from=G1, _to=G1),
]
G2.transitions = [
