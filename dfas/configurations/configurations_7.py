...
alphabet: dict[str, FunctionCall] = {
    "A": FunctionCall( 
        name="set_config",
        arguments={
            "key":       FunctionArgument(name="key",       value="backup-frequency", excluded_values=None, type="str"),
            "value":     FunctionArgument(name="value",     value="daily", excluded_values=None, type="str"),
            "category":  FunctionArgument(name="category",  value="storage", excluded_values=None, type="str"),
    ...
    "A'": FunctionCall( 
        name="set_config",
        arguments={
            "key":       FunctionArgument(name="key",       value=None, excluded_values=["backup-frequency"], type="str"),
            "value":     FunctionArgument(name="value",     value=None, excluded_values=["daily"], type="str"),
            "category":  FunctionArgument(name="category",  value=None, excluded_values=["storage"], type="str"),
            "timestamp": FunctionArgument(name="timestamp", value=None, excluded_values=None, type="str"),
        },
    ),
    "B": FunctionCall(  
    ...
    "B''": FunctionCall( 
        name="print_config",
        arguments={
            "key": FunctionArgument(name="key", value=None, excluded_values=["backup-frequency", "timeout"], type="str"),
        },
    ),
    "C": FunctionCall( 
        name="update_config",
        arguments={
            "key":       FunctionArgument(name="key",       value="timeout", excluded_values=None, type="str"),
            "new_value": FunctionArgument(name="new_value", value="10 minutes",      excluded_values=None, type="str"),
    ...
    "C'": FunctionCall( 
        ...
        arguments={
            ...
            "new_value": FunctionArgument(name="new_value", value=None, excluded_values=["10 minutes"], type="str"),
            "category":  FunctionArgument(name="category",  value=None, excluded_values=None, type="str"),
            "timestamp": FunctionArgument(name="timestamp", value=None, excluded_values=None, type="str"),
        },
    ),
