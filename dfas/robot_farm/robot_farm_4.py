...
G0 = Node("G0")                 # locked
G1 = Node("G1")                 # unlocked
G2 = Node("G2")                 # scanned B
G3 = Node("G3")                 # at plant_B
G4 = Node("G4")                 # sprayed B (20 ml)
G5 = Node("G5")                 # at collection_bin
G6 = Node("G6")                 # dumped
G7 = Node("G7", is_final=True)  # home
...
alphabet: dict[str, FunctionCall] = {
    ...
    "C": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=3.5,  type="float", excluded_values=None),
            "y":   FunctionArgument(name="y",   value=12.5, type="float", excluded_values=None),
    ...
    "C'''": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=None, type="float", excluded_values=[3.5, 6.0, 5.0]),
            "y":   FunctionArgument(name="y",   value=None, type="float", excluded_values=[12.5, 18.0, 5.0]),
    ...
    "H": FunctionCall(
        ...
        arguments={
            "plant_id": FunctionArgument(name="plant_id", value="plant_B", type="str",   excluded_values=None),
            "ml":       FunctionArgument(name="ml",       value=20.0,      type="float", excluded_values=None),
        },
    ),
    ...
    "H'": FunctionCall(
        name="spray_pesticide",
        arguments={
            "plant_id": FunctionArgument(name="plant_id", value=None, type="str",   excluded_values=["plant_B"]),
            "ml":       FunctionArgument(name="ml",       value=None, type="float", excluded_values=[20.0]),
        },
    ),
    ...
    "P": FunctionCall(
        name="scan_plant",
        arguments={"plant_id": FunctionArgument(name="plant_id", value="plant_B", type="str", excluded_values=None)},
    ),

    "P'": FunctionCall(
        name="scan_plant",
        arguments={"plant_id": FunctionArgument(name="plant_id", value=None, type="str", excluded_values=["plant_B"])},
    ),
...
G1.transitions = [
    Transition(symbols=["P"], _from=G1, _to=G2),
...
G3.transitions = [
    Transition(symbols=["H"], _from=G3, _to=G4),
...
G5.transitions = [
    Transition(symbols=["F"], _from=G5, _to=G6),
    Transition(symbols=READS, _from=G5, _to=G5),
]

G6.transitions = [
    Transition(symbols=["D", "C''"], _from=G6, _to=G7),
