...
G0 = Node("G0")                   # locked
G1 = Node("G1")                   # unlocked
G2 = Node("G2")                   # at plant_B
G3 = Node("G3")                   # sprayed B
G4 = Node("G4")                   # at pesticide_refill
G5 = Node("G5")                   # refilled pesticide
G6 = Node("G6")                   # at plant_D
G7 = Node("G7")                   # sprayed D
G8 = Node("G8", is_final=True)    # home / final
...
alphabet: dict[str, FunctionCall] = {
    ...
    "C'": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=18.0, type="float", excluded_values=None),
    ...
    "C''''": FunctionCall(
        name="move_to",
        arguments={
            "x":   FunctionArgument(name="x",   value=None, type="float", excluded_values=[3.5, 18.0, 16.5, 5.0]),
            "y":   FunctionArgument(name="y",   value=None, type="float", excluded_values=[12.5, 18.0, 15.0, 5.0]),
    ...
    "H": FunctionCall(
        ...
        arguments={
            ...
            "ml":       FunctionArgument(name="ml",       value=150.0,     type="float", excluded_values=None),
        },
    ),
    ...
    "H''": FunctionCall(
        name="spray_pesticide",
        arguments={
            "plant_id": FunctionArgument(name="plant_id", value=None, type="str",   excluded_values=["plant_B", "plant_D"]),
            "ml":       FunctionArgument(name="ml",       value=None, type="float", excluded_values=[150.0]),
        },
    ),
...
G2.transitions = [
    Transition(symbols=["H"], _from=G2, _to=G3),
...
G4.transitions = [
    Transition(symbols=["J"], _from=G4, _to=G5),
