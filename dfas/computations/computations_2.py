...
alphabet: dict[str, FunctionCall] = {
    ...
    "D": FunctionCall(
        name="divide_numbers",
        arguments={
            "a": FunctionArgument(name="a", value=100, excluded_values=None, type="int"),
    ...
    "D'": FunctionCall(
        name="divide_numbers",
        arguments={
            "a": FunctionArgument(name="a", value=None, excluded_values=[100], type="int"),
    ...
    "E": FunctionCall(
        name="power",
        arguments={
            "base":     FunctionArgument(name="base",     value=25, excluded_values=None, type="int"),
    ...
    "E'": FunctionCall(
        name="power",
        arguments={
            "base":     FunctionArgument(name="base",     value=None, excluded_values=[25], type="int"),
